...
export const metadata = {
  title: "Editor Guidelines | NexScholar",
  description: "Responsibilities, workflows, and best practices for Managing Editors on the NexScholar platform.",
};
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
      ...
      <div className="text-center space-y-5">
        ...
        <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
          Your role as a Managing Editor is central to maintaining the quality and integrity of NexScholar journals.
        </p>
        <Link href="/login">
